...
var locations = {
  "Burlington": [42.4879034, -71.1880388],
  "Arlington" : [42.4153, -71.1569],
   "CapeCod" : [41.66, -70.29],
  "FirebaseHQ": [37.785326, -122.405696]
  //"Caltrain": [37.7789, -122.3917]
};
...
var transitfeeds = {"Burlington":"mbta/vehicles", "Arlington":"mbta/vehicles", "CapeCod":"ccrta/vehicles", "FirebaseHQ": "sf-muni/vehicles"}; 

var myarea=getParameterByName('loc');
var myrad=getParameterByName('rad');
...
//var tset="sf-muni/vehicles";
//center = locations["Arlington"];
//tset="mbta/vehicles";
var center = locations[myarea];
var tset=transitfeeds[myarea];

document.getElementById("loc").value= myarea;
document.getElementById("rad").value= myrad;
 //alert(center + ' ' + tset) ;
// Query radius
var radiusInKm = parseFloat(myrad);
...
geoQuery.on("key_entered", function(vehicleId, vehicleLocation) {
  ...
  transitFirebaseRef.child(tset).child(vehicleId).once("value", function(dataSnapshot) {
...
//alert ("here");
  ...
  var marker = new google.maps.Marker({
   //icon: "https://chart.googleapis.com/chart?chst=d_bubble_icon_text_small&chld=" + vehicle.vtype + "|bbT|" + vehicle.routeTag + "|" + vehicleColor + "|eee",
	icon: "https://chart.googleapis.com/chart?chst=d_bubble_icon_text_small&chld=bus|bbT|" + vehicle.routeTag +"|FFFFFF|000000",
